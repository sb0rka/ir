...
export function ThemeProvider({
  ...
  const [resolvedAppearance, setResolvedAppearance] = useState<'light' | 'dark'>(() =>
    resolveAppearance((localStorage.getItem(storageKey) as Theme) || defaultTheme),
  )

  const applyAppearance = useCallback((appearance: 'light' | 'dark', animate: boolean) => {
