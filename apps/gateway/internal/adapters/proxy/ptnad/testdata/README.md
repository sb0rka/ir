...
The file lifecycle test builds a ZIP with an empty synthetic Ethernet PCAP, verifies
archive and extracted bytes, and never downloads an executable or lab attachment.
