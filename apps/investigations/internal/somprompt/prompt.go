...
func Build(title, description string, c Context) string {
	...
	b.WriteString("8. Final answer must quote `events`/`nodes`/`edges` from the write tool result verbatim. If no successful write happened, say nothing was written.\n\n")
