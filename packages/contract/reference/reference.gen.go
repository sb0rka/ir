...
type GetReference501JSONResponse struct{ NotImplementedJSONResponse }

func (response GetReference501JSONResponse) VisitGetReferenceResponse(w http.ResponseWriter) error {
